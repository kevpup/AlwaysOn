...
export function OuraHrvCard(_props: WidgetSkinProps) {
  return (
    <div className="flex h-full flex-col rounded-[30px] border border-white/[0.08] bg-[#111317] p-6 text-white shadow-[0_22px_46px_rgba(0,0,0,0.34)]">
      <div className="mb-5">
        ...
        <div className="mt-4 flex items-baseline gap-2">
          <p className="text-6xl font-semibold leading-none tracking-[-0.08em] text-white">48</p>
